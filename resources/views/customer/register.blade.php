...
<main id="content" role="main" class="main pt-0">
  <div class="container-fluid px-3">
    <div class="row">
      <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center  bg-light" style="background: url('{{ asset('assets/img/about-cover.jpg') }}') no-repeat center center; background-size: cover;">
